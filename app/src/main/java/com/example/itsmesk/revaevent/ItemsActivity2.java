...
public class ItemsActivity2 extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerAdapter (ItemsActivity2.this, mTeachers);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(ItemsActivity2.this);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(ItemsActivity2.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void onDeleteItemClick(int position) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void> () {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(ItemsActivity2.this, "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
